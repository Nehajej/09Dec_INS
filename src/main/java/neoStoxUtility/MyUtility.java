...
{
	public static String MyreadDataFromPropertyFile(String key) throws IOException
	{
	...
	public static String Myreadexcelsheet(int row, int cell) throws EncryptedDocumentException, IOException
	{
	...
	public static void Myscreenshot(WebDriver driver, String screenshotname) throws IOException
	{
	...
	public static void Myscrollingview(WebDriver driver,WebElement element)
	{
		Mywait(driver, 500);
	...
	public static void Mywait(WebDriver driver, int wait)
	{
